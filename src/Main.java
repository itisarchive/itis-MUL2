...
private static final String DEFAULT_TEXT = "Pociąg ze stacji Warszawa Wschodnia do stacji Poznań Główny przez stacje Kutno, Konin, odjedzie z toru drugiego przy peronie trzecim.";
...
void main(String[] args) throws Exception {
    String textToSay = normalizeText(args.length == 0 ? DEFAULT_TEXT : String.join(" ", args));
